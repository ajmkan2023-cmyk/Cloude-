...
OCCASIONS: tuple[Pattern, ...] = (
    Pattern(
        ...
        # المدد مضبوطة على جمل التعليق الصوتي: كل مشهد يبدأ قبل جملته
        # بثلث ثانية وينتهي بعدها، فلا تُقال جملة فوق مشهد لا يخصّها.
        # القطع السريع ثلاث صور لا أربع — أربع في ٣٫٣ ثانية كانت تُحسّ سريعة.
        slots=(
            Slot("national_title", 3.30, 1),
            Slot("flash", 3.30, 3),
            Slot("split", 3.20),
            Slot("emblem", 3.25, 0),
            Slot("split", 4.10),
