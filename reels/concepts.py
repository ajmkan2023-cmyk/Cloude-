...
BASE_TAGS = ("أجمكان", "شاليهات_الخبر", "الخبر", "المنطقة_الشرقية", "الدمام", "البحر")
...
CONCEPTS: tuple[Concept, ...] = (
    ...
    Concept(
        key="tour",
        name_ar="جولة في الشاليه",
        kicker="جولة سريعة",
        headline_template="جولة داخل\nشاليهات {topic}",
        scene_count=5,
        title_scene_seconds=3.2,
        photo_scene_seconds=3.4,
        outro_seconds=3.6,
        moves=("rise", "pan_left", "zoom_in", "pan_right", "zoom_out"),
        caption_opener="خذ جولة داخل شاليهات أجمكان على بحر الخبر 🏝",
        hashtags=BASE_TAGS + ("شاليهات", "شاليهات_الخبر"),
        guidance=(
            "جولة مكانية لا زمنية: المدخل أو الصالة، غرفة النوم بإطلالتها، "
            "المطبخ أو طاولة الطعام، التفاصيل (حمّام/إضاءة)، ثم المسبح. "
            "العنوان اسم المساحة، والسطر يصف ما تشعر به فيها."
        ),
        topic_hint="أجمكان",
    ),
    Concept(
