...
def cmd_demo() -> None:
    ...
    demo_shots = [
        ("البحر قدّامك", "جلسة على الرمل والموج على مرمى خطوة"),
        ("غروب كل يوم", "لون لا يتكرّر ولا يحتاج فلتر"),
        ("قريب من المدينة", "دقائق من الخبر وأنت في عالم ثاني"),
        ("أجواء عائلية", "مساحة تكفي اللمّة والضحك"),
        ("هدوء تستحقه", "بعيد عن الزحام، قريب من نفسك"),
    ]
    plan.shots = [
